/*
  ...
  /usr/bin/gengetopt --file-name=cvc-print-cmdline --output-dir=. 
...
const char *gengetopt_args_info_purpose = "Prints card verifiable certificate and its description";

const char *gengetopt_args_info_usage = "Usage: cvc-print [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->cvc_help = gengetopt_args_info_help[2] ;
  args_info->description_help = gengetopt_args_info_help[3] ;
  args_info->csr_help = gengetopt_args_info_help[4] ;
  args_info->cvc_dir_help = gengetopt_args_info_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->cvc_arg));
  free_string_field (&(args_info->cvc_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->cvc_given)
    write_into_file(outfile, "cvc", args_info->cvc_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* Card Verifiable Certificate.  */
        
        
          if (update_arg( (void *)&(args_info->cvc_arg), 
               &(args_info->cvc_orig), &(args_info->cvc_given),
              &(local_args_info.cvc_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'd':	/* Certificate description.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "cvc-dir") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->cvc_dir_arg), 
                 &(args_info->cvc_dir_orig), &(args_info->cvc_dir_given),
                &(local_args_info.cvc_dir_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "cvc-dir", '-',
                additional_error))
              goto failure;
