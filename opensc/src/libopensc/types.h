...
#define SC_MAX_APDU_BUFFER_SIZE		291 /* takes account of: CLA INS P1 P2 Lc [255 byte of data] Le */
...
struct sc_crt {
	...
	struct sc_crt_algo algo;		/* Algorithm ID */
...
typedef struct sc_apdu {
	...
	size_t plain_le; /* in SM case, holds the le value of plain APDU */
