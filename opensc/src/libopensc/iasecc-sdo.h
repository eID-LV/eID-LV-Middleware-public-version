...
#define IASECC_SDO_ECKEY_TAG_D			0x90
#define IASECC_SDO_ECKEY_TAG_OID		0x06
#define IASECC_SDO_ECKEY_TAG_COMPULSORY	0x80
#define IASECC_SDO_ECKEY_TAG_P			0x81
#define IASECC_SDO_ECKEY_TAG_A			0x82
#define IASECC_SDO_ECKEY_TAG_B			0x83
#define IASECC_SDO_ECKEY_TAG_G			0x84
#define IASECC_SDO_ECKEY_TAG_N			0x85
#define IASECC_SDO_ECKEY_TAG_Q			0x86
#define IASECC_SDO_ECKEY_TAG_H			0x87
...
#define IASECC_SDO_CLASS_EC_PRIVATE	0x12
#define IASECC_SDO_CLASS_EC_PUBLIC	0x22
...
struct iasecc_sdo_ec_prvkey {
	struct iasecc_extended_tlv oid;
	struct iasecc_extended_tlv d;
	struct iasecc_extended_tlv p;
	struct iasecc_extended_tlv a;
	struct iasecc_extended_tlv b;
	struct iasecc_extended_tlv g;
	struct iasecc_extended_tlv n;
	struct iasecc_extended_tlv h;
};

struct iasecc_sdo_prvkey  {
	unsigned char is_ecc;
	union
	{
		struct iasecc_sdo_rsa_prvkey rsa;
		struct iasecc_sdo_ec_prvkey ec;
	};
	struct iasecc_extended_tlv compulsory;
};

struct iasecc_sdo_rsa_pubkey {
	struct iasecc_extended_tlv n;
...
struct iasecc_sdo_pubkey  {
	union
	{
		struct iasecc_sdo_rsa_pubkey rsa;
		struct iasecc_sdo_ec_pubkey ec;
	};
	struct iasecc_extended_tlv compulsory;
};
