...
#define SC_PKCS15_ALGO_OP_DERIVE				0x0100
#define SC_PKCS15_ALGO_OP_NONREPUDIATION		0x0200
...
int sc_pkcs15_logout_pin(struct sc_pkcs15_card *card,
	struct sc_pkcs15_object *pin_obj);
...
int sc_pkcs15_find_so_pin(struct sc_pkcs15_card *card,
			struct sc_pkcs15_object **out);
int sc_pkcs15_find_unblocking_pin(struct sc_pkcs15_card *card,
	struct sc_pkcs15_object **out);
