...
typedef struct sc_security_env {
	...
	int non_repudiation;
	unsigned int key_mechanisms[SC_MAX_SUPPORTED_ALGORITHMS];
...
typedef struct sc_reader {
	...
	int pin_minLength, pin_maxLength, pin_limits_retrieved;
...
#define SC_PIN_STATE_NOT_INITIALIZED 2
...
#define SC_CARD_FLAG_GETRESP_NO_SM	0x00000008
...
int sc_parse_ef_atr_content(struct sc_card *card, unsigned char *buf, size_t buflen);
