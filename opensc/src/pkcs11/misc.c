...
static struct sc_to_cryptoki_error_conversion sc_to_cryptoki_error_map[]  = {
	...
	{ "C_Decrypt",		SC_ERROR_INCORRECT_PARAMETERS,		CKR_ENCRYPTED_DATA_INVALID},
	{ "C_InitPIN",		SC_ERROR_PIN_CODE_INCORRECT,		CKR_USER_NOT_LOGGED_IN},
	{ "C_Login",		SC_ERROR_DATA_OBJECT_NOT_FOUND,		CKR_USER_PIN_NOT_INITIALIZED},
	{NULL, 0, 0}
};
